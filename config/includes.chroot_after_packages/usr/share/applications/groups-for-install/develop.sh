...
if [[ $STATUS == *"'Develop'"* ]]; then
    ...
    gsettings set org.gnome.desktop.app-folders.folder:/org/gnome/desktop/app-folders/folders/Develop/ apps "['org.gnome.Builder.desktop', 'com.visualstudio.code.desktop', 'io.dbeaver.DBeaverCommunity.desktop', 'com.jetbrains.IntelliJ-IDEA-Community.desktop']"
