...
- Establecer firefox como aplicacion web predeterminada en configuracion (Igual hay que instalar primero Firefox y despues eliminar Firefox ESR) (Probar a usar el siguiente comando: xdg-settings set default-web-browser org.mozilla.firefox.desktop)